...
#' @author dhduncan
#' @export
get_clinical_fraction <- function(ve_symptoms = ve_symptoms, 
  ...
  age_vaccine_adjusted_clinical_fraction <- age_weighted_clinical_fractions * ve_reduction_factor
  
  return(age_vaccine_adjusted_clinical_fraction)
