...
withr::with_dir(here::here(), {
  tar_load(
    c(
      ...
      cases_vic,
      cases_vic_delays_long,
      plot_cases_vic_delays,
      derive_vic_delay_distributions,
      vic_delay_samples,
      vic_delay_samples_against_data,
      plot_hist_vic_delay_samples_v_data,
      plot_vic_tp_reduction
      )
    )
})
# 
...
```{r plot-hist-vic-delay-samples-v-data}
plot_hist_vic_delay_samples_v_data
```

```{r plot-vic-tp-reduction}
plot_vic_tp_reduction
```
